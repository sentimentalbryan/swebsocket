...
public class WebSocketHandshake {
	...
	WebSocketHandshake(URI url, int protocol, Object object,
	...
	WebSocketHandshake(URI url, int version, Object object,
	...
	public byte[] getHandshake() {
		...
		System.arraycopy(key3, 0, handshakeBytes, handshake.getBytes().length,
				8);
